...
export class OrderDetailComponent implements OnInit, OnDestroy {
    ...
    // Ratings in Perticular product
    rating(event) {
        const params: any = {};
        params.productId = event.productId;
        params.rating = this.reviewRating;
        params.orderProductId = event.orderProductId;
        this.accountSandbox.addRatings(params);
    }
}
